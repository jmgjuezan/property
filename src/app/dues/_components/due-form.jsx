    ...
    <form action={action} className="mx-75 my-5">
      ...
      <div className="space-y-12">
        <div className="grid grid-cols-1 gap-y-8">
          ...
          <div>
            <label htmlFor="coverageFromDate" className="block text-sm/6 font-medium text-white">
              Coverage From
            </label>
            <div className="mt-2">
              <input
                ...
                type="date"
                defaultValue={due?.coverageFromDate}
                className="block w-full rounded-md bg-white/5 px-3 py-1.5 text-base text-white outline-1 -outline-offset-1 outline-white/10 placeholder:text-gray-500 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-500 sm:text-sm/6 [&::-webkit-calendar-picker-indicator]:invert"
              />
            </div>
          </div>
          ...
          <div>
            <label htmlFor="coverageToDate" className="block text-sm/6 font-medium text-white">
              Coverage To
            </label>
            <div className="mt-2">
              <input
                ...
                name="coverageToDate"
                type="date"
                defaultValue={due?.coverageToDate}
                className="block w-full rounded-md bg-white/5 px-3 py-1.5 text-base text-white outline-1 -outline-offset-1 outline-white/10 placeholder:text-gray-500 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-500 sm:text-sm/6 [&::-webkit-calendar-picker-indicator]:invert"
              />
            </div>
          </div>
